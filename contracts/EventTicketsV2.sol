...
contract EventTicketsV2 {
    ...
    */
    function addEvent(string memory eventDescription, string memory url, uint numTickets) public isOwner returns(uint eventId){
        ...
        eventId = idGenerator;
        idGenerator += 1;
        emit LogEventAdded(eventDescription, url, numTickets, eventId);
    }
    ...
    */
    function getRefund(uint eventId) public {
        ...
        myEvent.totalTickets += ticketsRefunded;
        myEvent.sales -= ticketsRefunded;
        msg.sender.transfer(PRICE_TICKET * ticketsRefunded);
